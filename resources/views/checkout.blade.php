                    ...
                    <div class="row gx-5 px-3">
                        <div class="col mb-3">
                            <div class="row">
                                <div class="col">
                            <label for="paypal">
                            <img class="w-100" alt="paypal" id="paypal_tnr_img" src="{{route('home')}}/assets/img/Paypal-icon.png">
                            </label>
                            </div>
                             <div class="col">
                        ...
                        <div class="col mb-3">
                            ...
                            <img class="w-100" alt="Wire Transfer" id="wire_tnr_img"
