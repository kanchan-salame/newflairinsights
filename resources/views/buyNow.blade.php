                    ...
                    <div class="col-md-8">
                        ...
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form mt-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="pwd" placeholder="Enter Contact Number"
                                    name="pswd">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="countrySelect form-control form-control" id="country" name="country"
                                    ...
                                    <option value="af" data-country-name="Afghanistan " data-dial-code="93">Afghanistan
                                    </option>
                                    ...
                                    <option value="as" data-country-name="American Samoa" data-dial-code="1684">American
                                        Samoa</option>
                                    <option value="ad" data-country-name="Andorra" data-dial-code="376">Andorra</option>
                                    <option value="ao" data-country-name="Angola" data-dial-code="244">Angola</option>
                                    ...
                                    <option value="ba" data-country-name="Bosnia and Herzegovina "
                                        data-dial-code="387">Bosnia and Herzegovina </option>
                                    ...
                                    <option value="vg" data-country-name="British Virgin Islands"
                                        data-dial-code="1284">British Virgin Islands</option>
                                    ...
                                    <option value="bq" data-country-name="Caribbean Netherlands"
                                        data-dial-code="599">Caribbean Netherlands</option>
                                    ...
                                    <option value="cf" data-country-name="Central African Republic "
                                        data-dial-code="236">Central African Republic </option>
                                    ...
                                    <option value="cn" data-country-name="China " data-dial-code="86">China </option>
                                    <option value="cx" data-country-name="Christmas Island" data-dial-code="61">
                                        Christmas Island</option>
                                    <option value="cc" data-country-name="Cocos " data-dial-code="61">Cocos </option>
                                    ...
                                    <option value="ck" data-country-name="Cook Islands" data-dial-code="682">Cook
                                        Islands</option>
                                    <option value="cr" data-country-name="Costa Rica" data-dial-code="506">Costa Rica
                                    </option>
                                    ...
                                    <option value="cz" data-country-name="Czech Republic " data-dial-code="420">Czech
                                        Republic </option>
                                    ...
                                    <option value="eg" data-country-name="Egypt " data-dial-code="20">Egypt </option>
                                    ...
                                    <option value="fr" data-country-name="France" data-dial-code="33">France</option>
                                    <option value="gf" data-country-name="French Guiana " data-dial-code="594">French
                                        Guiana </option>
                                    ...
                                    <option value="gp" data-country-name="Guadeloupe" data-dial-code="590">Guadeloupe
                                    </option>
                                    ...
                                    <option value="in" data-country-name="India " data-dial-code="91">India </option>
                                    ...
                                    <option value="it" data-country-name="Italy " data-dial-code="39">Italy </option>
                                    <option value="jm" data-country-name="Jamaica" data-dial-code="1876">Jamaica
                                    </option>
                                    <option value="jp" data-country-name="Japan " data-dial-code="81">Japan </option>
                                    <option value="je" data-country-name="Jersey" data-dial-code="44">Jersey</option>
                                    ...
                                    <option value="lu" data-country-name="Luxembourg" data-dial-code="352">Luxembourg
                                    </option>
                                    ...
                                    <option value="mq" data-country-name="Martinique" data-dial-code="596">Martinique
                                    </option>
                                    ...
                                    <option value="fm" data-country-name="Micronesia" data-dial-code="691">Micronesia
                                    </option>
                                    ...
                                    <option value="mp" data-country-name="Northern Mariana Islands"
                                        data-dial-code="1670">Northern Mariana Islands</option>
                                    ...
                                    <option value="pr" data-country-name="Puerto Rico" data-dial-code="1">Puerto Rico
                                    </option>
                                    ...
                                    <option value="kn" data-country-name="Saint Kitts and Nevis"
                                        data-dial-code="1869">Saint Kitts and Nevis</option>
                                    ...
                                    <option value="pm" data-country-name="Saint Pierre and Miquelon "
                                        data-dial-code="508">Saint Pierre and Miquelon </option>
                                    ...
                                    <option value="sm" data-country-name="San Marino" data-dial-code="378">San Marino
                                    </option>
                                    <option value="st" data-country-name="São Tomé and Príncipe "
                                        data-dial-code="239">São Tomé and Príncipe </option>
                                    ...
                                    <option value="sc" data-country-name="Seychelles" data-dial-code="248">Seychelles
                                    </option>
                                    ...
                                    <option value="ss" data-country-name="South Sudan " data-dial-code="211">South
                                        Sudan </option>
                                    <option value="es" data-country-name="Spain " data-dial-code="34">Spain </option>
                                    ...
                                    <option value="sj" data-country-name="Svalbard and Jan Mayen"
                                        data-dial-code="47">Svalbard and Jan Mayen</option>
                                    ...
                                    <option value="tj" data-country-name="Tajikistan" data-dial-code="992">Tajikistan
                                    </option>
                                    ...
                                    <option value="tc" data-country-name="Turks and Caicos Islands"
                                        data-dial-code="1649">Turks and Caicos Islands</option>
                                    ...
                                    <option value="ae" data-country-name="United Arab Emirates "
                                        data-dial-code="971">United Arab Emirates </option>
